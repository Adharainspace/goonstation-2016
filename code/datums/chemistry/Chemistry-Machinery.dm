...
/obj/machinery/chem_dispenser/
	...
	mats = 30
	var/beaker = null
	var/list/dispensable_reagents = list("aluminium","barium","bromine","calcium","carbon","chlorine","chromium","copper","fluorine","ethanol","hydrogen","iodine","iron","lithium","magnesium","mercury","nickel","nitrogen","oxygen","plasma","platinum","phosphorus","potassium","radium","silicon","silver","sodium","sulfur","sugar","water")
